...
const Exchange = observer((props) => {
    ...
    const createReq = () => {
      if(exchange.countGive >= 100 && exchange.countGive <= 100000 && exchange.giveType == 'bank') {
        fetch('https://cleenswap.com/api/exchange/createRequest', {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
        body: JSON.stringify({user_id: user.userId, name: exchange.nameSurname, cashcard: exchange.cardNumber || null, cryptocard: exchange.cryptoWallet || null, firstcurrency: exchange.giveCryptoName, firstcurrencyquantity: exchange.countGive,
