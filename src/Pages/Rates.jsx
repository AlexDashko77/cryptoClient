        ...
        <div className="mainRates">
            ...
            <div className="info1">
                ...
                <div className="infoMain">
                    <p>{props.language ? "Наш сервис помогает производить обмен криптовалютой безопасно и быстро. Для вас время – это деньги? Онлайн-сервис для покупки и обмена криптовалют CleenSwap поможет вам его сэкономить! Теперь вы можете купить криптовалюту по-настоящему быстро – все обмены на CleenSwap обрабатываются не более 15 минут." : "Our service helps to exchange cryptocurrency safely and quickly. Is time money for you? The online service for buying and exchanging cryptocurrencies CleenSwap will help you save it! Now you can buy cryptocurrency really quickly - all exchanges on CleenSwap are processed no more than 15 minutes."}</p>
                    ...
                    <p>{props.language ? "CleenSwap гарантирует конфиденциальность и защищенность проводимых операций, мы никогда не передаем информацию о пользователях третьим лицам. Надежность нашего сервиса подтверждает множество отзывов довольных клиентов на авторитетных ресурсах." : "CleenSwap guarantees the confidentiality and security of transactions, we never share user information with third parties. The reliability of our service is confirmed by many reviews of satisfied customers on reputable resources."}</p>
                    <p>{props.language ? "Обменник CleenSwap позволяет не только купить или обменять криптовалюты. Теперь, приглашая пользователей, вы можете получать деньги в качестве процента от дохода CleenSwap. Также, для постоянных клиентов предусмотрена накопительная система скидок, размер которых определяется суммой успешно выполненных конверсионных действий конкретным пользователем." : "The CleenSwap exchanger allows you not only to buy or exchange cryptocurrencies. Now, by inviting users, you can receive money as a percentage of CleenSwap income. Also, for regular customers, a cumulative system of discounts is provided, the amount of which is determined by the amount of successfully completed conversion actions by a particular user."}</p>
                    <p>{props.language ? "Покупка криптовалюты с CleenSwap – это быстро, выгодно и безопасно!" : "Buying cryptocurrencies with CleenSwap is fast, profitable and safe!"}</p>
                </div>
            </div>
            </div>
    )
